...
<head>
    ...
    <title>Dog Park Finder | Report Delete Confirmation</title>
...
<body>
    ...
    <section class="container-sm">
        ...
        <h1 class="h1 text-center">Are you sure you want to delete the report for <?= $report->park->park_name?></h1>
        <form method="post" action="/console/reports/deleted/<?= $report->id?>" novalidate class="text-center">
            <?= csrf_field()?>
            <div class="row">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0 text-center p-2">
                    <a href="/console/reports/list" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
        </form>
    </section>
