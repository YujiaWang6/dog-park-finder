    ...
    <section class="container-sm">
        ...
        <form method="post" action="/console/reviews/edit/<?= $review->id?>" novalidation>
            ...
            <div class="mb-3">
                ...
                <select name="park_id" id="park_id" class="form-control">
                    ...
                    <?php foreach($parks as $park): ?>
                        <option value="<?= $park->id?>" <?= $park->id == old('park_name', $review->park_id) ? 'selected' : ''?>>
                            <?= $park->park_name?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="description" id="description" class="form-control" value="<?=old('description', $review->description)?>">
