...
<head>
    ...
    <title>Dog Park Finder | User Delete Confirmation</title>
...
<body>
    ...
    <section class="container-sm">
        ...
        <h1 class="h1 text-center">Are you sure you want to delete <?= $user->user_name?></h1>
        <form method="post" action="/console/users/deleted/<?= $user->id?>" novalidate class="text-center">
            <?= csrf_field()?>
            <div class="row">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0 text-center p-2">
                    <a href="/console/users/list" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
        </form>
    </section>
